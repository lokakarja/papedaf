...
export default function CreatePenugasanPage() {
		...
		<div>
			...
			<form onSubmit={handleSubmit}>
				<fieldset>
					...
					<textarea onChange={(e) => setJudul(e.target.value)} id="judul" />
					<br />
					...
					<fieldset>
						...
						<input onChange={(e) => setDasar(e.target.value)} id="dasar" />
						<br />
						<label htmlFor="noDasar">Nomor Surat</label>
						<input onChange={(e) => setNoDasar(e.target.value)} id="noDasar" />
						<br />
					...
					<select onChange={(e) => setBebanAnggaran(e.target.value)}>
					...
					{/* <fieldset>
						...
						<input onChange={(e) => setNoSurat(e.target.value)} id="noSurat" />
						<br />
